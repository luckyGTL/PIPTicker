...
#ifndef PIPTICKER_SWIFT_H
#define PIPTICKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PiPTicker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9PiPTicker20FinancialNewsManager")
@interface FinancialNewsManager : NSObject <UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC9PiPTicker15PiPAnchorUIView")
@interface PiPAnchorUIView : UIView
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC9PiPTicker10PiPManager")
...
@interface PiPManager (SWIFT_EXTENSION(PiPTicker)) <AVPictureInPictureControllerDelegate>
...
SWIFT_CLASS("_TtC9PiPTicker16PiPStockCardView")
@interface PiPStockCardView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
@end
...
SWIFT_CLASS("_TtC9PiPTicker23PiPTickerViewController")
@interface PiPTickerViewController : UIViewController
- (void)viewDidLoad;
